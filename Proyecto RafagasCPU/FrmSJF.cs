...
{
    public partial class FrmSJF : Form
    {
        ...
        private bool validarp5()
        {
            ...
            else
            {
                ...
                Array.Sort(Global.cpu);

                Global.retorno[0] = Global.cpu[0];
                Global.retorno[1] = Global.cpu[0] + Global.cpu[1];
                Global.retorno[2] = Global.cpu[0] + Global.cpu[1] + Global.cpu[2];
                Global.retorno[3] = Global.cpu[0] + Global.cpu[1] + Global.cpu[2] + Global.cpu[3];
                Global.retorno[4] = Global.cpu[0] + Global.cpu[1] + Global.cpu[2] + Global.cpu[3] + Global.cpu[4];
                ...
                lbl_espera1.Text = Convert.ToString("P3         " + Global.espera[0]);
                lbl_espera2.Text = Convert.ToString("P4         " + Global.espera[1]);
                lbl_espera3.Text = Convert.ToString("P1         " + Global.espera[2]);
                lbl_espera4.Text = Convert.ToString("P5         " + Global.espera[3]);
                lbl_espera5.Text = Convert.ToString("P4         " + Global.espera[4]);
